defmodule KattyWeb.Admin.SessionController do
  use KattyWeb, :controller

  import Katty.Admins.GenerateAdmin
  alias Katty.{Admins, Admins.Guardian}

  plug KattyWeb.Plugs.RedirectAdmin when action in [:new, :create]
