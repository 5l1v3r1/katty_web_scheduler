defmodule Katty.Users do
  ...
  alias Katty.Users.{User, UserToken, UserNotifier}

  def paginate_users(params \\ %{}) do
    Katty.Pagination.paginate_records(User, params)
  end
  ...
  defp create_personal_account({:ok, user} = result) do
    {:ok, account} =
      Katty.Accounts.create_account(
        user, %{personal: true, name: "#{user.email}"}
      )

    Katty.Accounts.create_membership(account, user, %{role: :owner})
