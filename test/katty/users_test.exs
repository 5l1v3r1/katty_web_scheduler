defmodule Katty.UsersTest do
  use Katty.DataCase

  alias Katty.Users

  import Katty.UsersFixtures
  alias Katty.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %Katty.Accounts.Account{personal: true} = user.personal_account
      assert [%Katty.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
