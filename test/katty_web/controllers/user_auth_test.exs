defmodule KattyWeb.UserAuthTest do
  ...
  @remember_me_cookie "_katty_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KattyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KattyWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "fetch_current_user/2" do
    test "authenticates user from session", %{conn: conn, user: user} do
      ...
      refute conn.assigns.current_account == nil
    end
